...
<div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <form action="<?php echo site_url('Banner/UpdateDataBanner'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group hidden">
                <label for="">Kode Banner</label>
                <input type="text" name="kd_banner" value="<?=$detail['kd_banner']?>" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <img id="show_image" src="<?php echo base_url()."/"."upload/".$detail['gambar'] ?>" class="img-responsive" style="width: 400px !important;height: auto" />
            </div>
