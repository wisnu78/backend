...
<div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <form method="POST" action="<?php echo site_url('Welcome/AddDataBarang'); ?>" enctype="multipart/form-data">

            <div class="form-group">
                <label>Daftar Menu</label>
                <select name="kategori_id" class="form-control kategori" style="width: 100% !important;">
                    <option></option>
                    <?php foreach ($tipe_menu as $kt) {?>
                        <option value="<?=$kt->kd_kategori?>"><?=$kt->name?></option>
                    <?php }?>
                </select>
            </div>
            <div class="form-group">
                <label>Kode barang</label>
                <input class="form-control" name="kd_barang" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control harga" name="harga" type="text">
            </div>
            <div class="form-group">
                <label>Detail</label>
